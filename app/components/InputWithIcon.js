    ...
    return (
        <div className=" mb-3 relative flex w-full items-stretch">
            ...
            <div
                ...
                className="cursor-pointer relative z-[2] rounded-l border-y border-l border-brown  px-5 py-2 text-xs font-medium uppercase text-brown transition duration-150 ease-in-out bg-transparent hover:bg-brown  hover:border-opacity-15 focus:outline-none focus:ring-0 shadow-md"
            >
                <Image
                    width={24}
                    height={24}
